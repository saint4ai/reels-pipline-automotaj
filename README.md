...
> токенов, доступов к серверам, клиентских данных и чужих медиа здесь нет — история
> состоит из одного коммита, проверяется одной командой из [SECURITY.md](SECURITY.md).
