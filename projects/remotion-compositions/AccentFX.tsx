...
const Marker: React.FC<{ text: string }> = ({ text }) => {
  ...
  return (
    <div style={{ position: "relative", padding: "6px 22px" }}>
      ...
      <div
        style={{
          position: "relative", fontFamily: "Benzin", fontWeight: 800, fontSize: 60,
...
const BigNumber: React.FC<{ to: number; label: string }> = ({ to, label }) => {
  ...
  return (
    <div style={{ textAlign: "center", transform: `scale(${0.75 + pop * 0.25})` }}>
      <div
        style={{
          fontFamily: "Benzin", fontWeight: 800, fontSize: 150, lineHeight: 1, color: LIME,
      ...
      <div
        style={{
          fontFamily: "Benzin", fontWeight: 800, fontSize: 38, color: "#fff",
...
const Strike: React.FC<{ text: string }> = ({ text }) => {
  ...
  return (
    <div style={{ position: "relative", padding: "0 10px" }}>
      <div
        style={{
          fontFamily: "Benzin", fontWeight: 800, fontSize: 60, color: "#fff",
      ...
      {items.map((t, i) => {
        ...
        return (
          ...
          >
            ...
            <div
              style={{
                fontFamily: "Benzin", fontWeight: 800, fontSize: 44, color: "#fff",
